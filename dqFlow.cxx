...
using MyTracks = soa::Join<aod::Tracks, aod::TrackSelection>;
...
struct DQEventQvector {
  ...
  void processBarrelQvectorRun2(MyEventsWithCent::iterator const& collisions, aod::BCsWithTimestamps const& bcs, soa::Filtered<MyTracks> const& tracks)
  {
  ...
  void processBarrelQvector(MyEventsWithCentRun3::iterator const& collisions, aod::BCsWithTimestamps const& bcs, soa::Filtered<MyTracks> const& tracks)
  {
  ...
  void processDummy(MyEvents const& collisions)
  {
    // do nothing
  }
